...
class BalloonTransition extends StatefulWidget {
  final Widget child;
...
class _BalloonTransitionState extends State<BalloonTransition>
  ...
  @override
  void didUpdateWidget(BalloonTransition oldWidget) {
    if (widget.hide) {
      _animationController.reverse();
    }
